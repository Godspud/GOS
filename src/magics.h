...
// sector types
#define FS_SECTOR_FREE 0x00
#define FS_SECTOR_ENTRY 0x01
#define FS_SECTOR_DATA 0x02
#define FS_SECTOR_EXTENT 0x03
#define FS_SECTOR_SUPERBLOCK 0x04

// file flags
#define FS_FILE_META 0b00000000
#define FS_DIR_META 0b00000001
#define FS_EXECUTABLE_FILE_META 0b00000010
#define FS_SYMLINK_DIR_META 0b00000011
#define FS_READONLY_META 0b00000100
#define FS_HIDDEN_META 0b00001000
#define FS_ENCRYPTED_META 0b00010000
#define FS_COMPRESSED_META 0b00100000
