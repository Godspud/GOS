...
static void cmd_test(int argc, char **argv)
{
    ...
    char other_stuff = 0;
    char filename[255] = "hi";
    char ext[15] = "123456789ABCDE";
    char throw[5] = {0};
    //  | HUH
    // \/
    ...
    int result = fs_create_file(filename, ext, "");
    ...
    {
        print_string("DISK FULL", COLOR_LIGHT_RED);
    }
    else if (result == -2)
    {
        print_string("filename too big", COLOR_LIGHT_RED);
    }
    else if (result == -3)
    {
        print_string("file ext too big", COLOR_LIGHT_RED);
    }
